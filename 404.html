            ...
            <div class="container rr-container-1410">
              <div class="breadcrumb-content">
                <div class="title-wrapper">
                  <h1 class="breadcrumb-title">404 Error Page</h1>
                </div>
          ...
          <div class="container rr-container-1410">
            <div class="error-area-inner section-spacing">
              <div class="error-content">
                <div class="thumb">
                  <img src="assets/imgs/gallery/gallery-48.webp" alt="image">
                </div>
                <div class="title-wrapper">
                  <h2 class="section-title">Oops! Page Not Found</h2>
                </div>
                <div class="text-wrapper">
                  <p class="text">Sorry, the page you are looking for doesn’t exist or has been moved.</p>
                </div>
                <div class="btn-wrapper">
                  <a href="index.html" class="rr-btn">
                    <span class="btn-wrap">
                      <span class="text-one">Got Back To Homepage <i class="fa-solid fa-arrow-right"></i></span>
                      <span class="text-two">Got Back To Homepage <i class="fa-solid fa-arrow-right"></i></span>
                    </span>
                  </a>
                </div>
              </div>
